...
#ya esta la lista de diccionarios "chistes" con lo estructurado de la api, ahora vamos a
#hacer otra lista de diccionarios llamada DatosProcesados

DatosProcesados = {
    "chistes_una_parte": "",
    "chistes_dos_partes": "",
    "prom_chistes_una_linea": "",
    "prom_chistes_dos_lineas": "",
    "prom_exito_ejecucion": ""
    }

DatosProcesados["chistes_una_parte"] = contador_single
DatosProcesados["chistes_dos_partes"] = contador_twopart
DatosProcesados["prom_chistes_una_linea"] = promedio_single
DatosProcesados["prom_chistes_dos_lineas"] = promedio_twopart
DatosProcesados["prom_exito_ejecucion"] = prom_error
...
fo = open ("Avance2Archivo.txt", "w")

for chiste in chistes:
    fo.write(str(chiste) + "\n")

for dato in ListaDatosProcesados:
    fo.write(str(dato))
